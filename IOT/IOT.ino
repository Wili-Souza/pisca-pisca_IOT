...
// WIFI
const char* SSID = "Seu_SSID"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "Sua_senha"; // Senha da rede WI-FI que deseja se conectar 
